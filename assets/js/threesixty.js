...
*/
function threesixtyFunction(pathImg, nbrImg) {
	...
	*/
	function loadImage() {
		...
		var imagePath = pathImg + (loadedImages + 1);
		var imageName = pathImg + (loadedImages + 1) + ".jpg";
		var srcsetImage = imagePath + "-400.jpg 400w, " + imagePath + "-600.jpg 600w, " + imagePath + ".jpg 1000w, " + imagePath + "-3000.jpg 3000w, " + imagePath + "-5000.jpg 5000w";
