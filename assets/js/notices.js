...
function noticesImages(nameImg){
    ...
    let nbrImg = document.getElementById("section-images").dataset.nbrImg;
...
function build(nameImg, nbrImg){
    ...
    for(n = 0; n < nbrImg; n++){
        ...
        imgNavDiapo.src = nameImg + number + "-400.jpg";
